...
/**
 * shash_table_get - Retrieve a value associated
...
/**
 * shash_table_print_rev - Function that prints a sorted hash table
 * in reverse order.
 * @ht: the sorted hash table to print
 *
 * Description: key/value are printed in the order that
